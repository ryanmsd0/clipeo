---
name: backlog-from-prd
description: "Convert a PRD/spec into an implementation backlog: epics, stories, acceptance criteria, priorities. Works with Jira/Linear, but can output plain Markdown tickets."
user-invocable: true
---
