    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-cols">
          <div className="fcol">
            <p className="fcol-t">Services</p>
            <Link href="/services">Le service Clipeo</Link>
            <Link href="/tarifs">Tarification CPM</Link>
            <Link href="/etudes-de-cas">Études de cas</Link>
            <Link href="/contact">Réserver un audit</Link>
          </div>
          <div className="fcol">
            <p className="fcol-t">Pour qui</p>
